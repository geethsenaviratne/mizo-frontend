      ...
      <footer className="px-4 sm:px-6 py-12 bg-[#f5f5f5]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-row flex-wrap gap-8 mb-12 text-center sm:text-left justify-center">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mb-6">
                Curated premium cosmetics and skincare products from around the world.
              </p>
              {/* Social Icons */}
              <div className="flex gap-3">
                <a href="#" className="w-10 h-10 bg-[#f8d7d0] rounded-full flex items-center justify-center hover:bg-[#f0c5bc] transition-colors">
          ...
          <div className="pt-8 border-t border-gray-300 text-center">
            <p className="text-gray-500 text-sm">© 2026 MIZO BEAUTY. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
